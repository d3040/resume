...
.. container:: abstract
    ...
    Busco un ambiente de colaboración que impulse la creatividad y la continua búsqueda de conocimiento sobre análisis de datos y desarrollo web para generar un impacto positivo en el entorno.
